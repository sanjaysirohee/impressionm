...
$fetch_detail = mysqli_query($con, "select * from tbl_blog where blog_id='$blog_id'");
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-material form-horizontal" action="controller/auth.php" method="post"
                            ...
                            <input type="hidden" name="update_id" value="<?= $res_detail['blog_id']; ?>">
                            <?php
...
">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-12" for="blog_heading">Blog Heading</span>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="blog_heading" name="blog_heading" class="form-control"
                                        placeholder="Enter Blog heading" value="<?= $res_detail['blog_heading']; ?>"
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-12" for="example-text">Blog Author</span>

                                </label>

                                <div class="col-md-12">

                                    <input type="text" id="example-text" name="blog_auther" class="form-control"
                                        placeholder="Enter Blog Author" value="<?= $res_detail['blog_auther']; ?>"
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                if (isset($_GET['blog_id'])) {
                                    ...
                                    <img src="images/blog/<?= $res_detail['blog_image']; ?>" style="max-width: 20%;">
                                ...
                                <label class="col-sm-12">Blog Detail Image</label>

                                <div class="col-sm-12">

                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">

                                        <input type="hidden" name="old_image" value="<?= $res_detail['blog_image']; ?>">



                                        <input type="file" name="uploaded_file" <?php echo (($blog_id == "") ? "required" : ""); ?>> </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                if (isset($_GET['blog_id'])) {
                                    ...
                                    <img src="images/blog/thumb/<?= $res_detail['thumb_image']; ?>" style="max-width: 20%;">
                                ...
                                <label class="col-sm-12">Blog Thumb Image</label>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        ...
                                        <input type="hidden" name="old_thumb_image"
                                            value="<?= $res_detail['thumb_image']; ?>">



                                        <input type="file" name="uploaded_thumb_file" <?php echo (($blog_id == "") ? "required" : ""); ?>> </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-12" for="altTag">Alt_tag</span>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="altTag" name="altTag" class="form-control"
                                        placeholder="Enter alt tag" value="<?= $res_detail['ogimage_alt_tag']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-12">BLog Description</label>

                                <div class="col-md-12">

                                    <textarea cols="50" id="editor1" name="blog_description" rows="10" required><?= $res_detail['blog_description']; ?>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-12" for="blogUrl">Blog_url</span>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <select name="is_published" class="form-control">
                                ...
                                <option value="1" <?php echo $res_detail['is_published'] == '1' ? 'selected' : '' ?>>
                                    Enable</option>
                                <option value="0" <?php echo $res_detail['is_published'] == '0' ? 'selected' : '' ?>>
                                    Disable</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-12" for="example-text">Popular</span>
                        ...
                        <div class="col-md-12">
                            <select name="is_popular" class="form-control">
                                <option value="">Select</option>
                                <option value="1" <?php echo $res_detail['is_popular'] == '1' ? 'selected' : '' ?>>Yes
                                </option>
                                <option value="0" <?php echo $res_detail['is_popular'] == '0' ? 'selected' : '' ?>>No
                                </option>
                            </select>
                        </div>
                ...
                if (isset($_GET['blog_id'])) {
                    ...
                    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"
                        name="btn_update_blog">Update</button>
                    ...
                    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"
                        name="btn_add_blog">Submit</button>
...
<?php if($blog_id == '') {?>
<script>
    $('#blog_heading').on('mouseleave', function () {
        var value = $(this).val();
        $('#blogUrl').val(value);
    })
</script>
