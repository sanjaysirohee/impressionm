...
$fetch_detail = mysqli_query($con, "select * from tbl_cities where id='$city_id'");
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Add City</h4>
            </div>
...
">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-12" for="fetch-title">Position</span>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="position" class="form-control"
                                        placeholder="Enter City Position" value="<?= $res_detail['position']; ?>"
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="fetch-title" name="name" class="form-control"
                                        placeholder="Enter City Name" value="<?= $res_detail['name']; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                if (isset($_GET['city_id'])) {
                                    ...
                                    <img src="images/cities/<?= $res_detail['image']; ?>" style="max-width: 20%;">
                                ...
                                <label class="col-sm-12">City Image</label>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        ...
                                        <input type="file" name="uploaded_file" <?php echo (($city_id == "") ? "required" : ""); ?>> </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                if (isset($_GET['city_id'])) {
                                    ...
                                    <img src="images/cities/thumb/<?= $res_detail['thumb_img']; ?>" style="max-width: 20%;">
                                ...
                                <label class="col-sm-12">City Thumb Image</label>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        ...
                                        <input type="file" name="uploaded_t_file" <?php echo (($city_id == "") ? "required" : ""); ?>> </span>
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-12" for="blogUrl">City_url</span>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="blogUrl" name="blogUrl" class="form-control"
                                placeholder="Enter city url" value="<?= str_replace('-', ' ', $res_detail['slug']); ?>">
                ...
                if (isset($_GET['city_id'])) {
                    ...
                    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"
                        name="btn_update_city">Update</button>
                    ...
                    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"
                        name="btn_add_city">Submit</button>
