...
define("RECIPIENT_EMAIL", "care@impressionmipl.com");
...
<body>
    ...
    try {
        ...
        $mail->Username = 'care@impressionmipl.com';  // sender gmail host
        ...
        $mail->setFrom('care@impressionmipl.com', "Impression Machinery Private Limited"); // sender's email and name
        //$mail->addAddress('veloxnsales@gmail.com');
        // receiver's email and name

        if ('Admin' == 'Admin') {
            $mail->addAddress('care@impressionmipl.com', "Admin");
    ...
    header('Location: https://impressionmipl.com/index');
} else {
